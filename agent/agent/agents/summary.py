...
from agent.tools.summary_tools import get_weekly_summary, list_weekly_summaries
...
class SummaryAgent:
    def __init__(self) -> None:
        ...
        self._graph = create_react_agent(
            ...
            tools=[get_weekly_summary, list_weekly_summaries, identify_stakeholders, send_confirmation_email],
